...
function GroupEdit() {
	...
	const [error, loading] = useGatherResources(groupID, group, setGroup, groupImage, setGroupImage, tempImage, setTempImage, changedImage, setChangedImage);
...
function useGatherResources(groupID, group, setGroup, groupImage, setGroupImage, tempImage, setTempImage, changedImage, setChangedImage) {
